...
analyze_and_graph_neural_fit_single_pdf_combined_multiple_tests(
	...
	smoothing_method="boxcar", window_size=100, poly_order=None, activation='tanh', l2_reg=0.0001, learning_rate=0.001,
	dropout_rate=0.5, layers=2, units=128, batch_size=256, bit_resolution=14, enable_hyperparameter_tuning=True
)
