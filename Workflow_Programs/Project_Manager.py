...
analyze_and_graph_calibrated_data_and_fits_single_pdf_combined_multiple_tests(test_range=TEST_RANGE, smoothing_method='boxcar', window_size=100, sensor_num=2, save_graphs=SAVE_GRAPHS, bit_resolution=12)
