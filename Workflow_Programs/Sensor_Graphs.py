...
# Modify your function to include the quantized model
def analyze_and_graph_neural_fit_single_pdf_combined_multiple_tests(
	...
	if use_hyperparameter_tuning and X_train is not None and y_train is not None:
		...
		# Build and train the neural network with quantization-aware training
		model = build_quantized_neural_network(input_dim=1, layers=layers, units=units, activation=activation,
	...
	# Start creating the plots for each layer and test
